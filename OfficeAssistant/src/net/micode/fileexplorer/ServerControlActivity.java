...
import com.client.ftp4j_1.FtpMainActivity;
import com.giant.MrAction.R;
import com.giant.initmember.GetPwActivity;
...
public class ServerControlActivity extends Fragment implements IBackPressedListener {
   ...
   Button buttonftpclient1;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        buttonftpclient1=(Button) mRootView.findViewById(R.id.buttonftpclient1);
        updateUi();
        ...
        buttonftpclient1.setOnClickListener(
                new OnClickListener() {
                    public void onClick(View v) {
                    	Intent intent = new Intent(getActivity(), FtpMainActivity.class);
