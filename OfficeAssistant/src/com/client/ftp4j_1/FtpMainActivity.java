...
import com.client.ftp4j_1.UploadFileChooserAdapter.FileInfo;
...
public class FtpMainActivity extends Activity implements OnClickListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.ftpcactivity_main);
		initView();
	...
	private Dialog createFTPLoginDialog() {
		...
		View rootLoadView = getLayoutInflater().inflate(R.layout.ftpcdialog_ftp_login,
				null);
		...
		return new AlertDialog.Builder(this)
				...
				.setPositiveButton("連接FTP", new DialogInterface.OnClickListener() {
	...
	private Dialog createLoadDialog() {
		...
		View rootLoadView = getLayoutInflater().inflate(
				R.layout.ftpcdialog_load_file, null);
		mPbLoad = (ProgressBar) rootLoadView.findViewById(R.id.pbLoadFile);

		progressDialog = new AlertDialog.Builder(this).setTitle("請稍後...")
	...
	private Dialog createRenameDialog() {
		...
		View rootLoadView = getLayoutInflater().inflate(R.layout.ftpcdialog_rename,
				null);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		getMenuInflater().inflate(R.menu.ftpclientactivity_main, menu);
		return true;
	}
	...
	private void initDialog() {
		fileChooserView = getLayoutInflater().inflate(
				R.layout.ftpcfilechooser_show, null);
