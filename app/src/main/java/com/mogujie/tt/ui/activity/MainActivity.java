...
public class MainActivity extends FragmentActivity{
	...
	private void initTab() {
		...
		mTabButtons[2] = (NaviTabButton) findViewById(R.id.tabbutton_chat);
		mTabButtons[3] = (NaviTabButton) findViewById(R.id.tabbutton_my);

		mTabButtons[0].setTitle("首頁");
		...
		mTabButtons[2].setSelectedImage(getResources().getDrawable(R.drawable.tt_tab_chat_sel));
		mTabButtons[2].setUnselectedImage(getResources().getDrawable(R.drawable.tt_tab_chat_nor));

		mTabButtons[3].setTitle("設計師");
